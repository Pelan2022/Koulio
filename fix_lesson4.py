...
# Vytvoříme nový soubor s pouze správnými kuličkami
with open("lesson4_kulicky_fixed.txt", "w", encoding="utf-8") as f:
    f.write("Lekce 4 - Skutečné bohatství\n")
    f.write("=" * 40 + "\n\n")
    for i, kulicka in enumerate(lesson4_kulicky, 1):
        f.write(f"{i}. {kulicka}\n")

print(f"Vytvoren soubor lesson4_kulicky_fixed.txt s {len(lesson4_kulicky)} kulickami")
