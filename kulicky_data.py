...
kulicky_data = {
    ...
    1: {  # Emoční prožitky
        "kulicky": [
            "zajetí v traumatu děsivé události odvrácení se od sebe",
            "zhroucení mého systému života přesvědčení že nic nezvládnu",
            "strach ze smrti ztráta kontroly",
            "pocit ohrožení života bolestné čelení realitě",
            "život jako jedno velké utrpení nepřetržitá ostražitost",
            "velký strach o svou existenci přehnané úlekové reakce",
            "strach o život svých blízkých pocit zastřené mysli",
            "strach z promarnění životních příležitostí zúžené vnímání",
            "sebevražedné sklony a myšlenky otupělost",
            "sebepoškozování útlum",
            "záchvaty vzteku pomílené představy",
            "bolestivé stavy panické ataky ustaranost o svou budoucnost",
            "pocit hrozící smrti zmítání se v pochybnostech",
            "pocit hrozícího konce sužování úzkostí",
            "předurčení k zániku život zastřen bolestí a smutkem",
            "žít jako pohřbena za živa extrémní strach a paniku",
            "vyhledávání nebezpečných situací ochromení mysli a emocí",
            "nesnesitelné pocity a emoce omezení schopnosti prožívat emoce",
            "naprostá nemohoucnost podrážděnost",
            "otupělá bolest způsobena zraněním posttraumatickou stresovou poruchu",
            "semletí životem změnu osobnosti skrze traumata",
            "aby mne traumatizující zážitek překrýval neschopnost milovat",
            "aktuální realitu",
            "otřesenost",
            "trvalé změny osobnosti díky stresu",
